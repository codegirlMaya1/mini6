...
def user_fines():
   while True:
    user_fines1=int(input("How many days is your book late?"))
    if user_fines1<= 5:
        print(f"You owe {user_cost}")
        payment=int(input(" Enter your payment amount: "))
    if payment != user_cost:
        print(" You have not satisfied your library debt please exit the system")
...
print("1. Alternative Menus are available")
